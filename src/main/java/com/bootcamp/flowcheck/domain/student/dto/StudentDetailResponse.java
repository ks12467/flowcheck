...
public class StudentDetailResponse {
    ...
    private LatestProgressResponse latestProgress;

    public static StudentDetailResponse of(Student student, LearningProgress latestProgress) {
        return new StudentDetailResponse(
                ...
                latestProgress != null ? LatestProgressResponse.of(latestProgress) : null
        );
    }
}
